...
const Skills = () => {
  return (
    <>
      <div className=' bg-text grid justify-center items-center mx-auto'>
      ...
      <div className=' bg-text justify-center items-center h-screen'>
        <div className='flex shadow-top-right justify-center items-center'>
          <div className='grid grid-cols-3 gap-6 mt-6 mx-2 justify-center items-center text-main sm:gap-10'>
