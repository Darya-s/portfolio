...
const Projects = () => {
  return (
    <div className='absolute top-[92%] left-0 w-full h-24 bg-blue-500 rounded-lg shadow-md z-10 -mt-1'>
      ...
      <div className='  bg-text shadow-top-right text-main flex justify-center items-center  sm:h-screen sm:max-h-[50vh]'>
